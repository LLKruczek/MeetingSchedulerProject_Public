...
fetch("sidenav.php")
    ...
    ******************************************************* -->
                    ...
                    <form action="write_new_event.php" method="post">
            ...
            <input class="rvt-input" type="text" id="eventOrganizer" name="eventOrganizer" required>
                            ...
                            <div class="rvt-m-top-sm">
                                ...
                                <textarea class="rvt-input" id="event_description" name="event_description" rows="4" placeholder="Enter the event description. Example: Join us for an exciting event!" required></textarea>
                            </div>
                        ...
                        <button class="rvt-button rvt-button--danger" type="button" onclick="saveAndExit()">Exit</button>
