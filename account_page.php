    ...
    <div class="rvt-layout__content [ rvt-p-top-xxl rvt-p-lr-md rvt-p-lr-xxl-md-up ]">
        <div class="rvt-prose">
            ...
            *************************************************************** -->
            ...
            <h1 class="rvt-m-top-xs">Account Details</h1>
        </div>
                    ...
                    <div class="rvt-prose rvt-flow">
                        ...
                        *************************************************** -->
                        ...
                        <div class="rvt-flex-md-up rvt-items-center rvt-p-bottom-xs rvt-p-lr-xxs rvt-border-bottom">
                            ...
                            *********************************************** -->
                            ...
                            <h2 class="rvt-grow-1 rvt-ts-18 rvt-text-regular">Account Details</h2>

                            <!-- **********************************************
                                Right-aligned action link
                            *********************************************** -->

                            <a href="edit_info.php" class="rvt-flex rvt-items-center rvt-link-plain rvt-m-top-sm rvt-m-top-none-md-up">
                                ...
                                <span class="rvt-ts-14 rvt-m-left-xs">Edit Personal Info</span>
                            </a>
                        </div>
                        ...
                        *************************************************** -->
                        <dl class="rvt-list-description rvt-m-top-lg">
                            <dt>Username</dt>
                            <dd><?php echo $userName." ".$userPronoun.""; ?></dd>
                            <dt>Email</dt>
                            <dd><?php echo $userEmail; ?></dd>
                            <dt>Phone Number</dt>
                            <dd><?php echo $phoneNumber; ?></dd>
                            <dt>Time Zone</dt>
                            <dd><?php echo $timeZone; ?></dd>
                        </dl>
