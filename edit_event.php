    ...
    <div class="rvt-layout__content [ rvt-p-top-xxl rvt-p-lr-md rvt-p-lr-xxl-md-up ]">
        <div class="rvt-prose">
            ...
            *************************************************************** -->
            ...
            <h1 class="rvt-m-top-xs">Edit Event</h1>
        </div>
        ...
        <div class="rvt-container-lg rvt-m-top-xl rvt-m-left-none rvt-m-right-none rvt-p-right-none rvt-p-left-none">
            <div class="rvt-row">
                <div class="rvt-cols-8-lg">
                        ...
                        *************************************************** -->
                        ...
                        <div class="rvt-flex-md-up rvt-items-center rvt-p-bottom-xs rvt-p-lr-xxs rvt-border-bottom">
                            ...
                            *********************************************** -->
                            ...
                            <h2 class="rvt-grow-1 rvt-ts-18 rvt-text-regular">Edit Event</h2>
                            ...
                            *********************************************** -->
                            ...
                            <a href="view_events.php" class="rvt-flex rvt-items-center rvt-link-plain rvt-m-top-sm rvt-m-top-none-md-up">
                                ...
                                <span class="rvt-ts-14 rvt-m-left-xs">View Events</span>
                            </a>
            		...
            		<?php //echo "event_id is ".$event_id; ?>
            		<?php 
                	    include"getEventDetails.php"; 
            		?>
     ...
     <fieldset class="rvt-fieldset">
            ...
            <input class="rvt-input" type="text" id="eventOrganizer" name="eventOrganizer" required>
                            ...
                            <div class="rvt-m-top-sm">
                                ...
                                <input class="rvt-input" type="text" id="event_name" name="event_name" placeholder=<?php echo $eventName; ?> required>
                            </div>
                            <div class="rvt-m-top-sm">
                                <label class="rvt-label" for="event_date">Event Date: <span class="rvt-color-orange-500 rvt-text-bold">*</span></label>
                                <input class="rvt-input" type="date" id="event_date" name="event_date" value=<?php echo $eventDate; ?> required>
                            </div>
                            <div class="rvt-m-top-sm">
                                <label class="rvt-label" for="event_time">Event Start Time: <span class="rvt-color-orange-500 rvt-text-bold">*</span></label>
                                <input class="rvt-input" type="time" id="event_start_time" name="event_start_time" value=<?php echo $eventStartTime; ?> required>
                            </div>
                            <div class="rvt-m-top-sm">
                                <label class="rvt-label" for="event_time">Event End Time: <span class="rvt-color-orange-500 rvt-text-bold">*</span></label>
                                <input class="rvt-input" type="time" id="event_end_time" name="event_end_time" value=<?php echo $eventEndTime; ?> required>
                            </div>
                            <div class="rvt-m-top-sm">
                                <label class="rvt-label" <label for="event_location">Event Location:  <span class="rvt-color-orange-500 rvt-text-bold">*</span></label>
                                <input class="rvt-input" type="text" id="event_location" name="event_location" placeholder=<?php echo $eventLocation; ?> required>
                            </div>
                            <div class="rvt-m-top-sm">
                                <label class="rvt-label" for="event_description">Event Description: </label>
                                <textarea class="rvt-input" id="event_description" name="event_description" rows="4" placeholder=<?php echo $eventDescription; ?>></textarea>
                            </div>
                          <!--  <div class="rvt-m-top-sm">
                        ...
                        <script>
                            ...
                            document.addEventListener("DOMContentLoaded", function () {
                                ...
                                form.addEventListener("submit", function (event) {
                                    ...
                                    fetch("write_updated_event.php?event_id="+<?php echo json_encode($event_id); ?>, {
                                        method: "POST",
                                        body: formData,
                                    })
