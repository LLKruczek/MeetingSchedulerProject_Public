            ...
            <ul class="rvt-sidenav__list">
                <li class="rvt-sidenav__item">
                    <div class="rvt-sidenav__item-wrapper">
                        <a href="account_page.php" class="rvt-sidenav__link" aria-current="page">Manage account</a>
                    ...
                    <ul class="rvt-sidenav__list" data-rvt-sidenav-list="toggle-2">
                        <li class="rvt-sidenav__item">
                            <a href="account_page.php" class="rvt-sidenav__link">View account details</a>
                        </li>

                        <li class="rvt-sidenav__item">
                            <a href="edit_info.php" class="rvt-sidenav__link">Edit personal info</a>
                        </li>
                        <li class="rvt-sidenav__item">
                            <a href="account_settings.php" class="rvt-sidenav__link">Account settings</a>
                        </li>
                ...
                <li class="rvt-sidenav__item">
                    <a href="view_events.php" class="rvt-sidenav__link">View Events</a>
                </li>
                <li class="rvt-sidenav__item">
                    <a href="create_event.php" class="rvt-sidenav__link">Create events</a>
                </li>
            </ul>
        </nav>
